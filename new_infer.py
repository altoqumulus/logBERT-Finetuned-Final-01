...
def cli():
    ...
    p.add_argument("--checkpoint",  default="checkpoints/best_ft.pt")
    p.add_argument("--drain_state", default="drain_state.bin")
    p.add_argument("--vocab_size",  type=int, required=True)
    p.add_argument("--topk",        type=int, default=5, help="g in paper")
    p.add_argument("--r",           type=int, default=3, help="miss-count cut-off")
